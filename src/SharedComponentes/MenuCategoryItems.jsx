    ...
    return (
        <div>
            ...
            <div className="flex justify-center my-8">
                <Link to='/shop'><button className="btn bg-transparent md:text-xl font-semibold border-0 border-b-4 border-b-gray-700  shadow-xl">ORDER YOUR FAVOURITE FOOD</button></Link>
            </div>
        </div>
    );
};
